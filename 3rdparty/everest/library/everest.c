...
int mbedtls_everest_make_params( mbedtls_ecdh_context_everest *ctx, xalSize_t *olen,
...
int mbedtls_everest_make_public( mbedtls_ecdh_context_everest *ctx, xalSize_t *olen,
                                 unsigned char *buf, xalSize_t blen,
                                 int( *f_rng )( void *, unsigned char *, xalSize_t ),
                                 void *p_rng )
{
...
int mbedtls_everest_calc_secret( mbedtls_ecdh_context_everest *ctx, xalSize_t *olen,
                                 unsigned char *buf, xalSize_t blen,
                                 int( *f_rng )( void *, unsigned char *, xalSize_t ),
                                 void *p_rng )
{
