                             ...
                             psa_algorithm_t alg )
{
    ...
    xalSize_t mac_length = sizeof( mac );
                                ...
                                psa_algorithm_t alg )
{
    ...
    xalSize_t iv_length = sizeof( iv );
    const unsigned char plaintext[16] = "Hello, world...";
    unsigned char ciphertext[32] = "(wabblewebblewibblewobblewubble)";
    xalSize_t ciphertext_length = sizeof( ciphertext );
    unsigned char decrypted[sizeof( ciphertext )];
    xalSize_t part_length;
                              ...
                              psa_algorithm_t alg )
{
    ...
    xalSize_t nonce_length = sizeof( nonce );
    unsigned char plaintext[16] = "Hello, world...";
    unsigned char ciphertext[48] = "(wabblewebblewibblewobblewubble)";
    xalSize_t ciphertext_length = sizeof( ciphertext );
    xalSize_t plaintext_length = sizeof( ciphertext );
                                   ...
                                   psa_algorithm_t alg )
{
    if( usage & ( PSA_KEY_USAGE_SIGN_HASH | PSA_KEY_USAGE_VERIFY_HASH ) )
    {
        ...
        xalSize_t payload_length = 16;
        unsigned char signature[PSA_SIGNATURE_MAX_SIZE] = {0};
        xalSize_t signature_length = sizeof( signature );
...
int mbedtls_test_psa_setup_key_derivation_wrap(
    ...
    psa_algorithm_t alg,
    const unsigned char* input1, xalSize_t input1_length,
    const unsigned char* input2, xalSize_t input2_length,
    xalSize_t capacity )
{
                                        ...
                                        psa_algorithm_t alg )
{
    ...
    xalSize_t input1_length = sizeof( input1 );
    unsigned char input2[] = "Input 2";
    xalSize_t input2_length = sizeof( input2 );
    unsigned char output[1];
    xalSize_t capacity = sizeof( output );
...
int mbedtls_test_psa_exported_key_sanity_check(
    ...
    const uint8_t *exported, xalSize_t exported_length )
{
                                ...
                                psa_key_usage_t usage )
{
    ...
    xalSize_t exported_size = 0;
    xalSize_t exported_length = 0;
    int ok = 0;
