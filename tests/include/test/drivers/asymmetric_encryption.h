...
psa_status_t mbedtls_test_transparent_asymmetric_encrypt(
    ...
    xalSize_t key_buffer_size, psa_algorithm_t alg, const uint8_t *input,
    xalSize_t input_length, const uint8_t *salt, xalSize_t salt_length,
...
psa_status_t mbedtls_test_opaque_asymmetric_encrypt(
    ...
    xalSize_t key_length, psa_algorithm_t alg, const uint8_t *input,
    xalSize_t input_length, const uint8_t *salt, xalSize_t salt_length,
    uint8_t *output, xalSize_t output_size, xalSize_t *output_length );
