...
typedef struct mbedtls_hmac_drbg_context
{
    ...
    xalSize_t MBEDTLS_PRIVATE(entropy_len);         /*!< entropy bytes grabbed on each (re)seed */
    ...
    /* Callbacks */
    int (*MBEDTLS_PRIVATE(f_entropy))(void *, unsigned char *, xalSize_t); /*!< entropy function */
