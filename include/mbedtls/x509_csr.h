 ...
 */
int mbedtls_x509_csr_parse( mbedtls_x509_csr *csr, const unsigned char *buf, xalSize_t buflen );
 ...
 */
int mbedtls_x509_csr_info( char *buf, xalSize_t size, const char *prefix,
 ...
 */
int mbedtls_x509write_csr_der( mbedtls_x509write_csr *ctx, unsigned char *buf, xalSize_t size,
 ...
 * \note            \p f_rng is used for the signature operation.
 */
int mbedtls_x509write_csr_pem( mbedtls_x509write_csr *ctx, unsigned char *buf, xalSize_t size,
                       int (*f_rng)(void *, unsigned char *, xalSize_t),
                       void *p_rng );
