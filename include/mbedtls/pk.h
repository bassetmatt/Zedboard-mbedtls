 ...
 */
typedef int (*mbedtls_pk_rsa_alt_decrypt_func)( void *ctx, xalSize_t *olen,
...
typedef xalSize_t (*mbedtls_pk_rsa_alt_key_len_func)( void *ctx );
 ...
 */
static inline xalSize_t mbedtls_pk_get_len( const mbedtls_pk_context *ctx )
{
...
int mbedtls_pk_parse_key( mbedtls_pk_context *ctx,
              const unsigned char *key, xalSize_t keylen,
 ...
 *                  error code
 */
int mbedtls_pk_write_key_der( const mbedtls_pk_context *ctx, unsigned char *buf, xalSize_t size );
 ...
 *                  error code
 */
int mbedtls_pk_write_pubkey_der( const mbedtls_pk_context *ctx, unsigned char *buf, xalSize_t size );
 ...
 */
int mbedtls_pk_write_pubkey_pem( const mbedtls_pk_context *ctx, unsigned char *buf, xalSize_t size );
 ...
 * \return          0 if successful, or a specific error code
 */
int mbedtls_pk_write_key_pem( const mbedtls_pk_context *ctx, unsigned char *buf, xalSize_t size );
 ...
 */
#if defined(MBEDTLS_FS_IO)
int mbedtls_pk_load_file( const char *path, unsigned char **buf, xalSize_t *n );
#endif
