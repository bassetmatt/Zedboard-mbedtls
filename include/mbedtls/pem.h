...
typedef struct mbedtls_pem_context
{
    ...
    xalSize_t MBEDTLS_PRIVATE(buflen);          /*!< length of the buffer                */
 ...
 * \note            The returned pointer remains valid only until \p ctx is
                    modified or freed.
 */
static inline const unsigned char *mbedtls_pem_get_buffer( mbedtls_pem_context *ctx, xalSize_t *buflen )
{
