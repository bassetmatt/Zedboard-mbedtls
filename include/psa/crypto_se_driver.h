...
typedef struct {
     ...
     */
    const xalSize_t MBEDTLS_PRIVATE(persistent_data_size);
...
typedef struct {
     ...
     * structure
    */
    xalSize_t                    MBEDTLS_PRIVATE(context_size);
...
typedef psa_status_t (*psa_drv_se_generate_key_t)(
    ...
    psa_key_slot_number_t key_slot,
    const psa_key_attributes_t *attributes,
    uint8_t *pubkey, xalSize_t pubkey_size, xalSize_t *pubkey_length);
...
typedef struct {
     ...
     * persistent data.
     */
    xalSize_t MBEDTLS_PRIVATE(persistent_data_size);
