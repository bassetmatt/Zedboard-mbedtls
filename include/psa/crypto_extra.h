...
typedef struct mbedtls_psa_stats_s
{
    ...
    xalSize_t MBEDTLS_PRIVATE(volatile_slots);
    /** Number of slots containing key material for a key which is in
     * internal persistent storage. */
    xalSize_t MBEDTLS_PRIVATE(persistent_slots);
    /** Number of slots containing a reference to a key in a
     * secure element. */
    xalSize_t MBEDTLS_PRIVATE(external_slots);
    /** Number of slots which are occupied, but do not contain
     * key material yet. */
    xalSize_t MBEDTLS_PRIVATE(half_filled_slots);
    /** Number of slots that contain cache data. */
    xalSize_t MBEDTLS_PRIVATE(cache_slots);
    /** Number of slots that are not used for anything. */
    xalSize_t MBEDTLS_PRIVATE(empty_slots);
    /** Number of slots that are locked. */
    xalSize_t MBEDTLS_PRIVATE(locked_slots);
 ...
 *                      (Value of type \c xalSize_t. The interpretation
