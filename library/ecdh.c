...
static int ecdh_make_params_internal( mbedtls_ecdh_context_mbed *ctx,
                                      xalSize_t *olen, int point_format,
 ...
 *      } ServerECDHParams;
 */
int mbedtls_ecdh_make_params( mbedtls_ecdh_context *ctx, xalSize_t *olen,
                              unsigned char *buf, xalSize_t blen,
                              int (*f_rng)(void *, unsigned char *, xalSize_t),
                              void *p_rng )
{
 ...
 */
int mbedtls_ecdh_make_public( mbedtls_ecdh_context *ctx, xalSize_t *olen,
                              unsigned char *buf, xalSize_t blen,
                              int (*f_rng)(void *, unsigned char *, xalSize_t),
                              void *p_rng )
{
...
static int ecdh_calc_secret_internal( mbedtls_ecdh_context_mbed *ctx,
                                      xalSize_t *olen, unsigned char *buf,
                                      xalSize_t blen,
                                      int (*f_rng)(void *,
                                                   unsigned char *,
                                                   xalSize_t),
 ...
 */
int mbedtls_ecdh_calc_secret( mbedtls_ecdh_context *ctx, xalSize_t *olen,
                              unsigned char *buf, xalSize_t blen,
                              int (*f_rng)(void *, unsigned char *, xalSize_t),
                              void *p_rng )
{
...
static int ecdh_tls13_make_params_internal( mbedtls_ecdh_context_mbed *ctx,
                                            xalSize_t *out_len, int point_format,
...
int mbedtls_ecdh_tls13_make_params( mbedtls_ecdh_context *ctx, xalSize_t *out_len,
                            unsigned char *buf, xalSize_t buf_len,
                            int ( *f_rng )( void *, unsigned char *, xalSize_t ),
                            void *p_rng )
{
