...
typedef struct {
   const char *name; /* String representation of AttributeType, e.g.
                      * "CN" or "emailAddress". */
   xalSize_t name_len;  /* Length of 'name', without trailing 0 byte. */
...
static const x509_attr_descriptor_t *x509_attr_descr_from_name( const char *name, xalSize_t name_len )
{
...
int mbedtls_x509_set_extension( mbedtls_asn1_named_data **head, const char *oid, xalSize_t oid_len,
                        int critical, const unsigned char *val, xalSize_t val_len )
{
    mbedtls_asn1_named_data *cur;
...
static int x509_write_name( unsigned char **p, unsigned char *start, mbedtls_asn1_named_data* cur_name)
{
    ...
    xalSize_t oid_len              = cur_name->oid.len;
    const unsigned char *name   = cur_name->val.p;
    xalSize_t name_len             = cur_name->val.len;
