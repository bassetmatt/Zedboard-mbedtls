...
int mbedtls_gcm_update( mbedtls_gcm_context *ctx,
                        const unsigned char *input, xalSize_t input_length,
                        ...
                        xalSize_t *output_length )
{
    ...
    *output_length = input_length;
    ...
    if( output > input && (xalSize_t) ( output - input ) < input_length )
        return( MBEDTLS_ERR_GCM_BAD_INPUT );
...
static const xalSize_t iv_len_test_data[MAX_TESTS] =
    { 12, 12, 12, 12, 8, 60 };
...
static const xalSize_t add_len_test_data[MAX_TESTS] =
    { 0, 0, 0, 20, 20, 20 };
...
static const xalSize_t pt_len_test_data[MAX_TESTS] =
    { 0, 16, 64, 60, 60, 60 };
...
int mbedtls_gcm_self_test( int verbose )
{
    ...
    for( j = 0; j < 3; j++ )
    {
        ...
        for( i = 0; i < MAX_TESTS; i++ )
        {
            ...
            {
                xalSize_t rest_len = pt_len_test_data[i] - 32;
