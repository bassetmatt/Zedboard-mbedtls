...
static psa_status_t psa_crypto_storage_load(
    const mbedtls_svc_key_id_t key, uint8_t *data, xalSize_t data_size )
{
    psa_status_t status;
    psa_storage_uid_t data_identifier = psa_its_identifier_of_slot( key );
    struct psa_storage_info_t data_identifier_info;
    xalSize_t data_length = 0;
    ...
    xalSize_t *data_length )
{
    ...
    *data_length = (xalSize_t) data_identifier_info.size;
                                      ...
                                      xalSize_t *data_length )
{
    ...
    uint8_t *loaded_data;
    xalSize_t storage_data_length = 0;
