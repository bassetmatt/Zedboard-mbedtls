...
static int mbedtls_ccm_crypt( mbedtls_ccm_context *ctx,
                              xalSize_t offset, xalSize_t use_len,
...
int mbedtls_ccm_set_lengths( mbedtls_ccm_context *ctx,
                             xalSize_t total_ad_len,
                             xalSize_t plaintext_len,
                             xalSize_t tag_len )
{
    /*
...
int mbedtls_ccm_update( mbedtls_ccm_context *ctx,
                        ...
                        unsigned char *output, xalSize_t output_size,
                        xalSize_t *output_len )
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    unsigned char i;
    xalSize_t use_len, offset, olen;
 ...
 */
static int ccm_auth_crypt( mbedtls_ccm_context *ctx, int mode, xalSize_t length,
                           const unsigned char *iv, xalSize_t iv_len,
                           const unsigned char *add, xalSize_t add_len,
 ...
 */
int mbedtls_ccm_star_encrypt_and_tag( mbedtls_ccm_context *ctx, xalSize_t length,
                         const unsigned char *iv, xalSize_t iv_len,
                         const unsigned char *add, xalSize_t add_len,
                         const unsigned char *input, unsigned char *output,
                         unsigned char *tag, xalSize_t tag_len )
...
int mbedtls_ccm_encrypt_and_tag( mbedtls_ccm_context *ctx, xalSize_t length,
                         const unsigned char *iv, xalSize_t iv_len,
                         const unsigned char *add, xalSize_t add_len,
                         const unsigned char *input, unsigned char *output,
                         unsigned char *tag, xalSize_t tag_len )
 ...
 */
static int mbedtls_ccm_compare_tags(const unsigned char *tag1, const unsigned char *tag2, xalSize_t tag_len)
{
    unsigned char i;
    int diff;
...
static int ccm_auth_decrypt( mbedtls_ccm_context *ctx, int mode, xalSize_t length,
                             const unsigned char *iv, xalSize_t iv_len,
                             const unsigned char *add, xalSize_t add_len,
                             const unsigned char *input, unsigned char *output,
...
int mbedtls_ccm_star_auth_decrypt( mbedtls_ccm_context *ctx, xalSize_t length,
                      const unsigned char *iv, xalSize_t iv_len,
                      const unsigned char *add, xalSize_t add_len,
                      const unsigned char *input, unsigned char *output,
                      const unsigned char *tag, xalSize_t tag_len )
...
int mbedtls_ccm_auth_decrypt( mbedtls_ccm_context *ctx, xalSize_t length,
                      const unsigned char *iv, xalSize_t iv_len,
                      const unsigned char *add, xalSize_t add_len,
                      const unsigned char *input, unsigned char *output,
                      const unsigned char *tag, xalSize_t tag_len )
...
static const xalSize_t iv_len_test_data [NB_TESTS] = { 7, 8,  12 };
static const xalSize_t add_len_test_data[NB_TESTS] = { 8, 16, 20 };
static const xalSize_t msg_len_test_data[NB_TESTS] = { 4, 16, 24 };
static const xalSize_t tag_len_test_data[NB_TESTS] = { 4, 6,  8  };
