...
int mbedtls_nist_kw_wrap( mbedtls_nist_kw_context *ctx,
                          ...
                          const unsigned char *input, xalSize_t in_len,
                          unsigned char *output, xalSize_t *out_len, xalSize_t out_size )
{
    int ret = 0;
    xalSize_t semiblocks = 0;
    xalSize_t s;
    xalSize_t olen, padlen = 0;
    uint64_t t = 0;
...
static int unwrap( mbedtls_nist_kw_context *ctx,
                   const unsigned char *input, xalSize_t semiblocks,
                   unsigned char A[KW_SEMIBLOCK_LENGTH],
                   unsigned char *output, xalSize_t* out_len )
{
    int ret = 0;
    const xalSize_t s = 6 * ( semiblocks - 1 );
    xalSize_t olen;
    uint64_t t = 0;
    unsigned char outbuff[KW_SEMIBLOCK_LENGTH * 2];
    unsigned char inbuff[KW_SEMIBLOCK_LENGTH * 2];
...
static const xalSize_t kw_msg_len[KW_TESTS] = { 16, 40, 24 };
static const xalSize_t kw_out_len[KW_TESTS] = { 24, 48, 32 };
...
static const xalSize_t kwp_msg_len[KW_TESTS] = { 9, 31, 1 };
...
static const xalSize_t kwp_out_len[KW_TESTS] = { 24, 40, 16 };
