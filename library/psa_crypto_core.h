...
static inline int mbedtls_psa_safer_memcmp(
    const uint8_t *a, const uint8_t *b, xalSize_t n )
{
    xalSize_t i;
...
const mbedtls_cipher_info_t *mbedtls_cipher_info_from_psa(
    psa_algorithm_t alg, psa_key_type_t key_type, xalSize_t key_bits,
...
psa_status_t psa_sign_message_builtin(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, xalSize_t key_buffer_size,
    psa_algorithm_t alg, const uint8_t *input, xalSize_t input_length,
