...
static void cmac_pad( unsigned char padded_block[MBEDTLS_CIPHER_BLKSIZE_MAX],
                      xalSize_t padded_block_len,
                      const unsigned char *last_block,
                      xalSize_t last_block_len )
{
    xalSize_t j;
...
int mbedtls_cipher_cmac_starts( mbedtls_cipher_context_t *ctx,
                                const unsigned char *key, xalSize_t keybits )
{
 ...
 */
int mbedtls_aes_cmac_prf_128( const unsigned char *key, xalSize_t key_length,
...
/* Sizes in bytes */
static const xalSize_t PRFKlen[NB_PRF_TESTS] = {
    18,
    16,
    10
};
