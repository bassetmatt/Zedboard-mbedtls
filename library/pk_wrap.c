...
static xalSize_t rsa_get_bitlen( const void *ctx )
{
                   ...
                   const unsigned char *sig, xalSize_t sig_len )
{
    ...
    xalSize_t rsa_len = mbedtls_rsa_get_len( rsa );
...
static xalSize_t eckey_get_bitlen( const void *ctx )
{
...
static int extract_ecdsa_sig_int( unsigned char **from, const unsigned char *end,
                                  unsigned char *to, xalSize_t to_len )
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    xalSize_t unpadded_len, padding_len;
...
static int extract_ecdsa_sig( unsigned char **p, const unsigned char *end,
                              unsigned char *sig, xalSize_t int_size )
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    xalSize_t tmp_size;
                       ...
                       const unsigned char *sig, xalSize_t sig_len )
{
    ...
    const xalSize_t signature_part_size = ( ctx->grp.nbits + 7 ) / 8;
    ((void) md_alg);
...
static xalSize_t rsa_alt_get_bitlen( const void *ctx )
{
...
static xalSize_t pk_opaque_get_bitlen( const void *ctx )
{
 ...
 */
static int pk_ecdsa_sig_asn1_from_psa( unsigned char *sig, xalSize_t *sig_len,
                                       xalSize_t buf_len )
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    xalSize_t len = 0;
    const xalSize_t rs_len = *sig_len / 2;
