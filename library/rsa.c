...
int mbedtls_rsa_import_raw( mbedtls_rsa_context *ctx,
                            unsigned char const *N, xalSize_t N_len,
                            unsigned char const *P, xalSize_t P_len,
                            unsigned char const *Q, xalSize_t Q_len,
                            unsigned char const *D, xalSize_t D_len,
                            unsigned char const *E, xalSize_t E_len )
{
    int ret = 0;
    RSA_VALIDATE_RET( ctx != NULL );
...
int mbedtls_rsa_export_raw( const mbedtls_rsa_context *ctx,
                            unsigned char *N, xalSize_t N_len,
                            unsigned char *P, xalSize_t P_len,
                            unsigned char *Q, xalSize_t Q_len,
                            unsigned char *D, xalSize_t D_len,
                            unsigned char *E, xalSize_t E_len )
{
    int ret = 0;
    int is_priv;
    RSA_VALIDATE_RET( ctx != NULL );
...
xalSize_t mbedtls_rsa_get_len( const mbedtls_rsa_context *ctx )
{
    return( ctx->len );
}
 ...
 */
static int mgf_mask( unsigned char *dst, xalSize_t dlen, unsigned char *src,
                      xalSize_t slen, mbedtls_md_context_t *md_ctx )
{
...
int mbedtls_rsa_rsaes_pkcs1_v15_encrypt( mbedtls_rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, xalSize_t),
                                 void *p_rng, xalSize_t ilen,
                                 const unsigned char *input,
                                 unsigned char *output )
{
    xalSize_t nb_pad, olen;
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    unsigned char *p = output;
                         ...
                         unsigned char *sig )
{
    ...
    xalSize_t slen, min_slen, hlen, offset = 0;
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    xalSize_t msb;
    const mbedtls_md_info_t *md_info;
    mbedtls_md_context_t md_ctx;
...
static int rsa_rsassa_pkcs1_v15_encode( mbedtls_md_type_t md_alg,
                                        ...
                                        unsigned char *dst )
{
    xalSize_t oid_size  = 0;
    xalSize_t nb_pad    = dst_len;
    unsigned char *p = dst;
    const char *oid  = NULL;
                               ...
                               const unsigned char *sig )
{
    ...
    unsigned int hlen;
    xalSize_t observed_salt_len, msb;
    const mbedtls_md_info_t *md_info;
    mbedtls_md_context_t md_ctx;
    unsigned char buf[MBEDTLS_MPI_MAX_SIZE];
    ...
    if( expected_salt_len != MBEDTLS_RSA_SALT_LEN_ANY &&
        observed_salt_len != (xalSize_t) expected_salt_len )
    {
        ret = MBEDTLS_ERR_RSA_INVALID_PADDING;
        goto exit;
    }
...
#if defined(MBEDTLS_PKCS1_V15)
static int myrand( void *rng_state, unsigned char *output, xalSize_t len )
{
