 ...
 */
static inline void ecp_mpi_load( mbedtls_mpi *X, const mbedtls_mpi_uint *p, xalSize_t len )
{
    X->s = 1;
...
static int ecp_group_load( mbedtls_ecp_group *grp,
                           const mbedtls_mpi_uint *p,  xalSize_t plen,
                           const mbedtls_mpi_uint *a,  xalSize_t alen,
                           const mbedtls_mpi_uint *b,  xalSize_t blen,
                           const mbedtls_mpi_uint *gx, xalSize_t gxlen,
                           const mbedtls_mpi_uint *gy, xalSize_t gylen,
                           const mbedtls_mpi_uint *n,  xalSize_t nlen,
...
static inline int ecp_mod_koblitz( mbedtls_mpi *N, mbedtls_mpi_uint *Rp, xalSize_t p_limbs,
                                   xalSize_t adjust, xalSize_t shift, mbedtls_mpi_uint mask )
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    xalSize_t i;
    mbedtls_mpi M, R;
