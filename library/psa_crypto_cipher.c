...
psa_status_t mbedtls_psa_cipher_set_iv(
    mbedtls_psa_cipher_operation_t *operation,
    const uint8_t *iv, xalSize_t iv_length )
{
    ...
    xalSize_t *output_length )
{
    ...
    xalSize_t block_size = ctx->cipher_info->block_size;
    xalSize_t internal_output_length = 0;
    *output_length = 0;
    ...
    if( ctx->unprocessed_len > 0 )
    {
        ...
        xalSize_t bytes_to_copy = block_size - ctx->unprocessed_len;
...
{
    psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
    xalSize_t expected_output_size;
    ...
    xalSize_t *output_length )
{
    ...
    xalSize_t update_output_length, finish_output_length;
    ...
    xalSize_t *output_length )
{
    psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
    mbedtls_psa_cipher_operation_t operation = MBEDTLS_PSA_CIPHER_OPERATION_INIT;
    xalSize_t olength, accumulated_length;
