...
typedef struct
{
    ...
    xalSize_t ad_size; /* Size of the additional data, which is this header. */
    xalSize_t payload_size; /* Size of the encrypted data. */
...
static psa_status_t run( enum program_mode mode,
                         const char *key_file_name,
                         const char *ladder[], xalSize_t ladder_depth,
