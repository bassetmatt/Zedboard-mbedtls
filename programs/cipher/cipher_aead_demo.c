...
void print_buf( const char *title, unsigned char *buf, xalSize_t len )
{
    printf( "%s:", title );
 ...
 */
static void aead_info( const mbedtls_cipher_context_t *ctx, xalSize_t tag_len )
{
 ...
 */
static int aead_encrypt( mbedtls_cipher_context_t *ctx, xalSize_t tag_len,
        const unsigned char *iv, xalSize_t iv_len,
        const unsigned char *ad, xalSize_t ad_len,
        const unsigned char *part1, xalSize_t part1_len,
        const unsigned char *part2, xalSize_t part2_len )
{
    int ret;
    xalSize_t olen;
