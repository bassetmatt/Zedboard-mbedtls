                        ...
                        mbedtls_tls_prf_types tls_prf_type )
{
    ...
    xalSize_t const client_random_len = 32;
    xalSize_t len = 0;
    xalSize_t j;
...
int ssl_check_record( mbedtls_ssl_context const *ssl,
                      unsigned char const *buf, xalSize_t len )
{
...
int recv_cb( void *ctx, unsigned char *buf, xalSize_t len )
{
...
int recv_timeout_cb( void *ctx, unsigned char *buf, xalSize_t len,
                     uint32_t timeout )
{
    io_ctx_t *io_ctx = (io_ctx_t*) ctx;
    int ret;
...
int send_cb( void *ctx, unsigned char const *buf, xalSize_t len )
{
    io_ctx_t *io_ctx = (io_ctx_t*) ctx;
 ...
 *  for more info.
 */
int x509_crt_verify_info( char *buf, xalSize_t size, const char *prefix,
                          uint32_t flags )
{
