...
static int write_ssl_data( mbedtls_ssl_context *ssl, unsigned char *buf, xalSize_t len )
{
    int ret;
...
static int write_ssl_and_get_response( mbedtls_ssl_context *ssl, unsigned char *buf, xalSize_t len )
{
    int ret;
...
static int write_and_get_response( mbedtls_net_context *sock_fd, unsigned char *buf, xalSize_t len )
{
    int ret;
    unsigned char data[128];
    char code[4];
