...
int convert_pem_to_der( const unsigned char *input, xalSize_t ilen,
 ...
 */
static int write_file( const char *path, unsigned char *buf, xalSize_t n )
{
    FILE *f;
...
int main( int argc, char *argv[] )
{
    ...
    char buf[1024];
    xalSize_t pem_size, der_size = sizeof(der_buffer);
    int i;
    char *p, *q;
